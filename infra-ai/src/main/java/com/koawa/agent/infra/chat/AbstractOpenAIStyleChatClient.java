...
import com.koawa.agent.framework.trace.RagStreamTraceSupport;
import com.koawa.agent.framework.trace.RagStreamTraceSupport.StreamSpan;
import com.koawa.agent.infra.config.AIModelProperties;
import com.koawa.agent.infra.enums.ModelCapability;
import com.koawa.agent.infra.http.HttpMediaTypes;
import com.koawa.agent.infra.http.HttpResponseHelper;
import com.koawa.agent.infra.http.ModelClientErrorType;
import com.koawa.agent.infra.http.ModelClientException;
import com.koawa.agent.infra.http.ModelUrlResolver;
