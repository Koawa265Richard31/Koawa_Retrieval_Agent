...
package com.koawa.agent.knowledge.service.impl;
...
import com.koawa.agent.core.chunk.ChunkEmbeddingService;
import com.koawa.agent.core.chunk.ChunkingMode;
import com.koawa.agent.core.chunk.ChunkingOptions;
import com.koawa.agent.core.chunk.ChunkingStrategy;
import com.koawa.agent.core.chunk.ChunkingStrategyFactory;
import com.koawa.agent.core.chunk.VectorChunk;
import com.koawa.agent.core.parser.DocumentParserSelector;
import com.koawa.agent.core.parser.ParserType;
import com.koawa.agent.framework.context.UserContext;
import com.koawa.agent.framework.exception.ClientException;
import com.koawa.agent.framework.mq.producer.MessageQueueProducer;
import com.koawa.agent.ingestion.dao.entity.IngestionPipelineDO;
import com.koawa.agent.ingestion.dao.mapper.IngestionPipelineMapper;
import com.koawa.agent.ingestion.domain.context.IngestionContext;
import com.koawa.agent.ingestion.domain.pipeline.PipelineDefinition;
import com.koawa.agent.ingestion.engine.IngestionEngine;
import com.koawa.agent.ingestion.service.IngestionPipelineService;
import com.koawa.agent.knowledge.config.KnowledgeScheduleProperties;
import com.koawa.agent.knowledge.controller.request.KnowledgeChunkCreateRequest;
import com.koawa.agent.knowledge.controller.request.KnowledgeDocumentPageRequest;
import com.koawa.agent.knowledge.controller.request.KnowledgeDocumentUpdateRequest;
import com.koawa.agent.knowledge.controller.request.KnowledgeDocumentUploadRequest;
import com.koawa.agent.knowledge.controller.vo.KnowledgeChunkVO;
import com.koawa.agent.knowledge.controller.vo.KnowledgeDocumentChunkLogVO;
import com.koawa.agent.knowledge.controller.vo.KnowledgeDocumentSearchVO;
import com.koawa.agent.knowledge.controller.vo.KnowledgeDocumentVO;
import com.koawa.agent.knowledge.dao.entity.KnowledgeBaseDO;
import com.koawa.agent.knowledge.dao.entity.KnowledgeChunkDO;
import com.koawa.agent.knowledge.dao.entity.KnowledgeDocumentChunkLogDO;
...
import com.koawa.agent.knowledge.dao.mapper.KnowledgeDocumentChunkLogMapper;
import com.koawa.agent.knowledge.dao.mapper.KnowledgeDocumentMapper;
import com.koawa.agent.knowledge.enums.DocumentStatus;
import com.koawa.agent.knowledge.enums.ProcessMode;
import com.koawa.agent.knowledge.enums.SourceType;
import com.koawa.agent.knowledge.handler.RemoteFileFetcher;
import com.koawa.agent.knowledge.mq.event.KnowledgeDocumentChunkEvent;
import com.koawa.agent.knowledge.schedule.CronScheduleHelper;
import com.koawa.agent.knowledge.service.KnowledgeChunkService;
import com.koawa.agent.knowledge.service.KnowledgeDocumentScheduleService;
import com.koawa.agent.knowledge.service.KnowledgeDocumentService;
import com.koawa.agent.rag.core.vector.VectorSpaceId;
import com.koawa.agent.rag.core.vector.VectorStoreService;
import com.koawa.agent.rag.dto.StoredFileDTO;
import com.koawa.agent.rag.service.FileStorageService;
