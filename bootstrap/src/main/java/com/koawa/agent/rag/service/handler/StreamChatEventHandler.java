...
package com.koawa.agent.rag.service.handler;

import cn.hutool.core.util.StrUtil;
import com.koawa.agent.rag.dao.entity.ConversationDO;
import com.koawa.agent.rag.dto.CompletionPayload;
import com.koawa.agent.rag.dto.MessageDelta;
import com.koawa.agent.rag.dto.MetaPayload;
import com.koawa.agent.rag.enums.SSEEventType;
import com.koawa.agent.framework.context.UserContext;
import com.koawa.agent.framework.convention.ChatMessage;
import com.koawa.agent.framework.web.SseEmitterSender;
...
//StreamChatEventHandler 接收 LLM 流式 chunk，把 chunk 发给前端，并在完成时保存 assistant 回复。
