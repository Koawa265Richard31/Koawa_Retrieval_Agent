...
/**
 * 流式对话 Trace 包装器
 * 给一次流式 RAG 问答包一层 Trace，记录这次请求什么时候开始、什么时候出第一个字、什么时候结束、是否失败。
 */
@Slf4j
@Component
