...
package com.koawa.agent.rag.core.memory;
...
import com.koawa.agent.rag.service.ConversationGroupService;
...
import static com.koawa.agent.rag.constant.RAGConstant.CONVERSATION_SUMMARY_PROMPT_PATH;
...
public class JdbcConversationMemorySummaryService implements ConversationMemorySummaryService {
    ...
    private static final String SUMMARY_LOCK_PREFIX = "koawa-agent:memory:summary:lock:";
