...
class AgenticRetrievalShadowServiceTests {
    ...
    @Test
    void submittedWorkRunsBecauseRoutingWasAlreadyDecided() {
    ...
    @Test
    void submittedSingleSubQuestionRunsBecauseComplexityLivesInRouter() {
        AgenticRetrievalShadowRunner runner = mock(AgenticRetrievalShadowRunner.class);
        new AgenticRetrievalShadowService(runner, Runnable::run)
                .submit(
                        "task",
